...
<form name="fboardform" id="fboardform" method="post" action="/BeautyInSite/write.do" onsubmit="return fboardform_submit(this);" autocomplete="off" enctype="MULTIPART/FORM-DATA">
...
<div class="btn_confirm">
	...
	<a href="javascript:history.go(-1);" class="btn_lsmall bx-white">목록으로</a>
	<%
...
%>
    ...
    %>
        <a href="/BeautyInSite/noticeUpdate.do?noticeNo=<%=noticeVO.getNoticeNo() %>" class="btn_lsmall bx-white">수정</a>
			<a href="/BeautyInSite/noticeDelete.do?noticeNo=<%=noticeVO.getNoticeNo() %>" class="btn_lsmall bx-white">삭제</a>
    <%
        }
    %>
