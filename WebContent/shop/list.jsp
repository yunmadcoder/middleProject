		...
		<div class="cont_inner">
			...
			<div class="tab_sort">
				...
				<ul>
					...
					<li><a
						href="/shop/listtype.php?type=1&page_rows=&sort=PROD_PRICE&sortodr=asc">낮은가격순</a></li>
					<li><a
						href="/shop/listtype.php?type=1&page_rows=&sort=PROD_PRICE&sortodr=desc">높은가격순</a></li>
					<!-- 					<li><a -->
					<!-- 						href="/shop/listtype.php?type=1&page_rows=&sort=m_count&sortodr=desc">후기많은순</a></li> -->
					<li><a
						href="/shop/listtype.php?type=1&page_rows=&sort=PROD_DATE&sortodr=desc">최근등록순</a></li>
				</ul>
				<!-- <select id="page_rows"
					onchange="location='/shop/listtype.php?type=1&sort=&sortodr=&page_rows='+this.value;">
