...
List<Map<String, Object>> prodSearchList = (List<Map<String, Object>>) request.getAttribute("prodSearchList");
	...
	<div id="wrapper">
		...
		<div id="snb">
			...
			<dl>
				...
				<dd class="o10">
					<a href="<%=request.getContextPath()%>/admin/orderlist.do">주문리스트(전체)</a>
				</dd>
				<dd class="o10">
					<a href="<%=request.getContextPath()%>/admin/shipdetail.do">배송관리</a>
				</dd>
				<dd class="o10 ">
					<a href="<%=request.getContextPath()%>/admin/release.do">출고관리</a>
				</dd>
				<dt class="o20 menu_toggle">상품 관리</dt>
				<dd class="o20">
					<a href="<%=request.getContextPath()%>/prodWrite.do">상품 등록</a>
				</dd>
				<dd class="o20 active">
					<a href="<%=request.getContextPath()%>/prodList.do">상품 리스트(전체)</a>
				</dd>
			</dl>
		</div>
		<div id="content">
			...
			<div class="s_wrap">
				...
				<form name="fsearch" id="fsearch" method="get"
					...
					<!-- <input type="hidden" name="code" value="검색"> -->
					<div class="tbl_frm01">
						<table class="tablef">
							<colgroup>
								<col class="w100">
				...
				<form name="fgoodslist" id="fgoodslist" method="post"
					...
					<div class="tbl_head02">
						...
						<table id="sodr_list" class="tablef">
							...
							for (Map<String, Object> pv : prodSearchList) {
...
// 		alert( $(this).text() );
		location.href="/BeautyInSite/prodSearchaAdmin.do?cate=<%=cate%>&search=<%=search%>&page=" + $(this).text();
	});
	...
	$('.next').on('click',function(){
		...
		location.href=location.href="/BeautyInSite/prodSearchaAdmin.do?cate=<%=cate%>&search=<%=search%>&page=" + currentPage;
	});
	...
	$('.prev').on('click',function(){
		...
		location.href="/BeautyInSite/?cate=<%=cate%>&search=<%=search%>
						&page="
													+ currentPage;
										});
					</script>
