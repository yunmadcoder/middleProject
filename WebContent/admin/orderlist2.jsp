...
<% 
	...
	List<Map<String, Object>> orderSerchList = (List<Map<String, Object>>)request.getAttribute("orderSerchList");
...
<% 
		...
		for(Map<String, Object> ov : orderSerchList) {
			if(ov != null){
	            Reader reader;
	            BufferedReader br;
	            String result = "";
...
%>
	<tr class="list0">
		...
		<td class="td_img"><img src="<%=result %>" width="50" height="50">
		</td>
...
// 		alert( $(this).text() );
		location.href="/BeautyInSite/orderSerch.do?cate=<%=cate%>&search=<%=search%>&page=" + $(this).text();
	});
	...
	$('.next').on('click',function(){
		...
		location.href=location.href="/BeautyInSite/orderSerch.do?cate=<%=cate%>&search=<%=search%>&page=" + currentPage;
	});
